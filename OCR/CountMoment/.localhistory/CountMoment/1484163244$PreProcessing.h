...
public:
	...
	void preProcessing2(cv::Mat image) {
		...
		CPreProcessing::removeBlackBackground2(imageSign);
		//Change angle
		//CPreProcessing::autoRotate(imageSign, 0);
...
#pragma region static methods
	...
	static void removeBlackBackground2(cv::Mat& image) {
