...
public:
	...
	const string		PATH_FILE_FEATURES_MOMENTS		= "data\\libsvm\\";
	const string		FILE_NAME_FEATURES_MOMENTS		= "FV.txt";
	...
	static void addVectorToFile(int* labels, float** trainingData, string nameFile, int size, int nFeatures = 31, bool scale = true) {

		fstream plik(nameFile, ios::app);
		if (plik.good()) {
	...
	static string getNLineFromFile(string nameFile, int n) {
