...
void Threshold_Demo(int, void*)
{
	...
	Mat element = getStructuringElement(threshold_type, Size(2 * threshold_size + 1, 2 * threshold_size + 1), Point(threshold_size, threshold_size));
	cv::dilate(src.clone(), dst, element);
