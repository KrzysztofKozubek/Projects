...
int main() {
	...
	namedWindow("3", 1);
	namedWindow("4", 1);
	createTrackbar("Value", "1", &A, maxA, SegmentationCell);
	createTrackbar("Value", "2", &A, maxA, SegmentationCell);
	createTrackbar("Value", "3", &A, maxA, SegmentationCell);
	createTrackbar("Value", "4", &A, maxA, SegmentationCell);
