...
OCR::OCR(QWidget *parent) : QMainWindow(parent) {
	...
	// 12 11 6
	this->imageSign		= imread("digit//digits15.jpg", 0);
...
void OCR::preProcessing() {
	...
	//Find value skip
	int skipL = CPreProcessing::getSkipTValue(imageSign.clone());
	...
	CPreProcessing::cutImage(imageSign, skipL, skipT, skipR, skipB);
