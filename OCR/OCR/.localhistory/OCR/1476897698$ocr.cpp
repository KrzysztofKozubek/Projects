...
OCR::OCR(QWidget *parent) : QMainWindow(parent) {
	...
	connect(ui.BLoadImage3, SIGNAL(clicked()), this, SLOT(loadImage()));
	...
	this->imageSignO = imread("digits.jpg", CV_BGR2GRAY);
	displayImageInLabel(this->imageSign, ui.LImage3);
	displayImageInLabel(this->imageSign, ui.LImage2);
...
void OCR::loadImage() {
	...
	displayImage(loadImageFrom(ui.LEPathImageLoad3->text()), ui.LImage3);
}
