...
double OCR::advRow(Mat image, int row, int NUMBER_MARGIN_MISSTAKE) { return (sumRow(image, row, NUMBER_MARGIN_MISSTAKE) / (NUMBER_MARGIN_MISSTAKE * image.rows)); }

double OCR::advCol(Mat image, int col, int NUMBER_MARGIN_MISSTAKE) { return (sumColumn(image, col, NUMBER_MARGIN_MISSTAKE) / (NUMBER_MARGIN_MISSTAKE * image.cols)); }
