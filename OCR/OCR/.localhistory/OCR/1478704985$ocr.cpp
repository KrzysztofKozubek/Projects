...
float* OCR::countMoment(Mat image, int without) {
	...
	trainingData[i] = m.m00;
	trainingData[i] = m.m10;
	trainingData[i] = m.m01;
	trainingData[i] = m.m20;
	trainingData[i] = m.m11;
	trainingData[i] = m.m02;
	trainingData[i] = m.m30;
	trainingData[i] = m.m21;
	trainingData[i] = m.m12;
	trainingData[i] = m.m03;
