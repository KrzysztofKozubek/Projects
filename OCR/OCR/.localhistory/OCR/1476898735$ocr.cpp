...
void OCR::changeBinaryOrErode() {
	...
	//Erode
	Mat element = getStructuringElement(ui.HSErodeElement3->value, Size(2 * ui.HSErodeKernel3->value + 1, 2 * ui.HSErodeKernel3->value + 1), Point(erosion_size, erosion_size));
