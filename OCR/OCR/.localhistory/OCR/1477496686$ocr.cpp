...
void OCR::changeBinaryOrErode() {
	...
	int erosion_size2 = 1;
	Mat element = getStructuringElement(MORPH_RECT, Size(2 * erosion_size2 + 1, 2 * erosion_size2 + 1), Point(erosion_size2, erosion_size2));
	erode(imageSignO.clone(), tmp, element);
