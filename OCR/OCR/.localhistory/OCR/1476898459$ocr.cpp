...
OCR::OCR(QWidget *parent) : QMainWindow(parent) {
	...
	connect(ui.HSBinaryElement3, SIGNAL(sliderReleased()), this, SLOT(changeContrasOrBrightness()));
	connect(ui.HSBinaryKernel3, SIGNAL(sliderReleased()), this, SLOT(changeContrasOrBrightness()));
	connect(ui.HSErodeElement3, SIGNAL(sliderReleased()), this, SLOT(changeContrasOrBrightness()));
	connect(ui.HSErodeKernel3, SIGNAL(sliderReleased()), this, SLOT(changeContrasOrBrightness()));
