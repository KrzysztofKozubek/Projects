...
OCR::OCR(QWidget *parent) : QMainWindow(parent) {
	...
	this->imageSign		= imread("digit//digits02.jpg", 0);
...
void OCR::preProcessing() {
	...
	CPreProcessing::toBinary(imageSign, ui.HSBinaryKernel3->value(), 70);

	//Change angle
	CPreProcessing::autoRotate(imageSign);

	CPreProcessing::cutImage(imageSign, 150, 70, 150, 100);
