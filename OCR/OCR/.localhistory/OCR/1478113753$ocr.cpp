...
OCR::OCR(QWidget *parent) : QMainWindow(parent) {
	...
	connect(ui.BRightImageCell4, SIGNAL(clicked()), this, SLOT(SegmentationIncreaseIndexImageCell()));
	connect(ui.BLeftImageCell4, SIGNAL(clicked()), this, SLOT(SegmentationReduceIndexImageCell()));
...
vector<float>* OCR::countMoment(Mat image) {
