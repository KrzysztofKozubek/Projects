...
void OCR::changeBinaryOrErode() {
	...
	//Erode
	tmp = imageSign.clone();
	Mat element = getStructuringElement(ui.HSErodeElement3->value,
		Size(2 * ui.HSErodeKernel3->value + 1, 2 * ui.HSErodeKernel3->value + 1),
		Point(ui.HSErodeKernel3->value, ui.HSErodeKernel3->value));
