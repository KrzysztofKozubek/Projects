...
void OCR::preProcessing() {
	...
	CPreProcessing::toBinary(imageSign, ui.HSBinaryKernel3->value(), skip - 1);

	//Change angle
	CPreProcessing::autoRotate(imageSign, 90);

	CPreProcessing::cutImage(imageSign, 150, 90, 150, 100);
