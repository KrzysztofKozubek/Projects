...
<div class="container">
    ...
    <div class="alert alert-info text-center">
        <strong>
            ...
            Your movie has been added to your list
        </strong>
    </div>
    <div class="row">
...
active;
                            ...
                            echo <<< active
                    <li><a data-toggle="tab" href="#sectionA">Description</a></li>
                    <li><a data-toggle="tab" href="#sectionB">Actors</a></li>
                    <li><a data-toggle="tab" href="#sectionC">Creators</a></li>
                    <li class="active"><a data-toggle="tab" href="#sectionD">Comments</a></li>
                    <li><a data-toggle="tab" href="#sectionE">Awards</a></li>
active;
                        }
                    ?>
                ...
                <div class="tab-content">
                    <div id="sectionA" class="tab-pane fade <?php if(!isset($_POST['idUser'])) echo "in active" ?>">
                    ...
                    <div id="sectionD" class="tab-pane fade <?php if(isset($_POST['idUser'])) echo "in active" ?>"">
                        <?php
                        if(!empty($comments)) {
                            ?>
                            <table class="table table-hover">
