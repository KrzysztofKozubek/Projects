...
<div class="alert alert-danger text-center"><strong><span class="glyphicon glyphicon-send"></span> Failed to sign in. Reason: <?php echo $error; ?> Try again :)</strong></div>
<div class="row">
    <div class="col-md-6">
        <div id="logbox">
            <form id="signup" method="post" action="<?php echo "$ip/user/"; ?>">
                <h1>Zaloguj się</h1>
                <input name="email" type="email" placeholder="wpisz email" autofocus="autofocus" class="input pass" maxlength="50" value="<?php echo "$email"; ?>"/>
