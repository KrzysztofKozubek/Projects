...
@Component({
  selector: 'app-piechart-group-transaction',
  templateUrl: './piechart.group.transaction.component.html',
  styleUrls: ['./piechart.group.transaction.component.css']
})
export class PieChartGroupTransactionComponent extends BaseData {
  ...
  constructor(
    ...
    this?.filters?.patchValue({
      transactionType: this._transactionType[1]
    });
  }
