...
@Component({
  ...
  templateUrl: './transaction.component.edit.html',
  styleUrls: ['./transaction.component.edit.css']
})
export class TransactionEditComponent implements OnInit {
  ...
  editTransaction() {
    this.transactionService.funEdit(this._transaction, EMPTY_FUN, EMPTY_FUN);
