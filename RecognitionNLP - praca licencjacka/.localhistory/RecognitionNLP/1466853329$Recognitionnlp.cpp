...
void RecognitionNLP::myTest() {
	...
	for (int c = 1; c < 10000; c *= 2) {
		...
		CSVM::cmdRun("echo " + pathTest + "svm-predict.exe " + pathTest + test1Zb1 + "00.model R.txt " + pathTest + test1Training + " >> " + GS_Linear);
		CSVM::cmdRun("echo " + pathTest + "svm-predict.exe " + pathTest + test1Zb1 + "00.model R.txt " + pathTest + test1Training + " >> " + GS_Linear);
	}
	...
	for (int c = 1; c < 10000; c *= 2) {
		for (double g = 0.001; g < 10; g *= 2) {
			...
			CSVM::cmdRun("echo " + pathTest + "svm-predict.exe " + pathTest + test1Zb2 + "02.model R.txt " + pathTest + test1Training + " >> " + GS_RBF);
			CSVM::cmdRun("echo " + pathTest + "svm-predict.exe " + pathTest + test1Zb2 + "02.model R.txt " + pathTest + test1Training + " >> " + GS_RBF);
		}
	}
