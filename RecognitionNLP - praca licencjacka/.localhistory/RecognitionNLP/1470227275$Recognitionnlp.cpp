...
#pragma endregion create parameters segmentation
	...
	for (int c = 1; c < 10000; c *= 2) {
		...
		insertToFile(GS_LINEAR, "echo Kernel = Linear, Test = I, C = " + itos(c) + ": Result classification =");
		insertToFile(GS_LINEAR, "echo ..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_I + " ..\\" + PATH_MODEL_LINEAR + " ..\\" + RESULT_FILE);
		insertToFile(GS_LINEAR, "echo echo Kernel = Linear, Test = II, C = " + itos(c) + ": Result classification = ");
	...
	for (int c = 1; c < 10000; c *= 2) {
		...
		CSVM::cmdRun("echo ..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_I + " ..\\" + PATH_MODEL_LINEAR + " ..\\" + RESULT_FILE + " >> " + GS_LINEAR);
		CSVM::cmdRun("echo echo Kernel = Linear, Test = II, C = " + itos(c) + ": Result classification = >> " + GS_LINEAR);
		CSVM::cmdRun("echo ..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_II + " ..\\" + PATH_MODEL_LINEAR + " ..\\" + RESULT_FILE + " >> " + GS_LINEAR);
	}
	...
	for (int c = 1; c < 10000; c *= 2) {
		for (double g = 0.001953125; g < 10; g *= 2) {
			...
			CSVM::cmdRun("echo ..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_I + " ..\\" + PATH_MODEL_RBF + " ..\\" + RESULT_FILE + " >> " + GS_RBF);
			CSVM::cmdRun("echo echo Kernel = RBF, Test = II, C = " + itos(c) + ", g = " + itos(g) + ": Result classification = >> " + GS_RBF);
			CSVM::cmdRun("echo ..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_II + " ..\\" + PATH_MODEL_RBF + " ..\\" + RESULT_FILE + " >> " + GS_RBF);
		}
	}
