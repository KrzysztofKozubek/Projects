...
#pragma endregion create parameters segmentation
	...
	for (int c = 1; c < 10000; c *= 2) {
		...
		CSVM::cmdRun("echo " + PATH_LIBSVM + "svm-predict.exe " + PATH_NVF_TEST_I + " " + pathTest + test1Training + "00.model R.txt " + " >> " + GS_LINEAR);
		CSVM::cmdRun("echo " + PATH_LIBSVM + "svm-predict.exe " + PATH_NVF_TEST_II + " " + pathTest + test1Training + "00.model R.txt " + " >> " + GS_LINEAR);
	}
