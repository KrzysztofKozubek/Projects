...
#pragma endregion create parameters segmentation
	...
	/* SAVE TEST I VF */
	nu_svm.saveVectorToFile(labelTestI, dataTestI, PATH_CLASSIFIER, VF_TRAINING, PATH_LIBSVM, PATH_CLASSIFIER, vLabelTrain.size());
	nu_svm.saveVectorToFile(labelTestI, dataTestI, PATH_CLASSIFIER, PATH_SET_ONE, PATH_LIBSVM, PATH_CLASSIFIER, vLabelTestI.size());
	/* SAVE TEST II VF */
	nu_svm.saveVectorToFile(labelTestII, dataTestII, PATH_CLASSIFIER, PATH_SET_TWO, PATH_LIBSVM, PATH_CLASSIFIER, vLabelTestII.size());
