...
void RecognitionNLP::myTest() {
	...
	/* LOAD DATA */
	clearFolder(PATH_TRAIN_DEFOR);
	clearFolder(PATH_TRAIN_PROCE);
	clearFolder(PATH_TRAIN_SEGME);
	clearFolder(PATH_TESTI_DEFOR);
	clearFolder(PATH_TESTI_PROCE);
	clearFolder(PATH_TESTI_SEGME);
	clearFolder(PATH_TESII_DEFOR);
	clearFolder(PATH_TESII_PROCE);
	clearFolder(PATH_TESII_SEGME);
