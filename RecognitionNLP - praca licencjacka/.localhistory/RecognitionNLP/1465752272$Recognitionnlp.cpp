...
void RecognitionNLP::myTest() {
	...
	CSVM::cmdRun("echo SET \"g=0.5\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -r %r% -g %g% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "03.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -r %r% -g %g% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "03.model >> " + pathTest + "skrypt.bat");
