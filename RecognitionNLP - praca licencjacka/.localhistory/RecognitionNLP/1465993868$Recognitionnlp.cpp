...
void RecognitionNLP::setParameters() {
	...
	for (double c = 100000; c > 0.0001; c/=10) {
		...
		CSVM::cmdRun("echo C:\\Test\\svm-train.exe -s %svm% -t %kernel% -c " + itos(c) + " -q C:\\Test\\SVF.txt C:\\Test\\SVFTraining.txt00.model >> C:\\Test\\linear.bar");
		
		CSVM::cmdRun("echo echo svm-train.exe -s %svm% -t %kernel% -c " + itos(c) + " >> C:\\Test\\r.txt >> C:\\Test\\linear.bar");
		
		CSVM::cmdRun("echo C:\\Test\\svm-predict.exe C:\\Test\\SVFT1Zb1.txt C:\\Test\\SVFTraining.txt00.model C:\\Test\\result >> C:\\Test\\r.txt >> C:\\Test\\linear.bar");
		CSVM::cmdRun("echo C:\\Test\\svm-predict.exe C:\\Test\\VF.txt C:\\Test\\SVFTraining.txt00.model C:\\Test\\result >> C:\\Test\\r.txt >> C:\\Test\\linear.bar");

		CSVM::cmdRun("C:\\Test\\svm-train.exe -s %svm% -t %kernel% -c " + itos(c) + " -q C:\\Test\\SVF.txt C:\\Test\\SVFTraining.txt00.model");

		CSVM::cmdRun("echo svm-train.exe -s %svm% -t %kernel% -c " + itos(c)+ " >> C:\\Test\\r.txt");
		CSVM::cmdRun("C:\\Test\\svm-predict.exe C:\\Test\\SVFT1Zb1.txt C:\\Test\\SVFTraining.txt00.model C:\\Test\\result >> C:\\Test\\r.txt");
		CSVM::cmdRun("C:\\Test\\svm-predict.exe C:\\Test\\VF.txt C:\\Test\\SVFTraining.txt00.model C:\\Test\\result >> C:\\Test\\r.txt");
	}
}
