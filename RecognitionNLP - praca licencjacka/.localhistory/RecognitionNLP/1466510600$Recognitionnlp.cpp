...
void RecognitionNLP::myTest() {
	...
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -e %e% -c %c% -q " + pathTest + test1Training + " " + pathTest + test2Training + "00.model >> " + pathTest + "skrypt.bat");
	...
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -g %g% -e %e% -c %c% -q " + pathTest + test1Training + " " + pathTest + test2Training + "02.model >> " + pathTest + "skrypt.bat");
