...
void RecognitionNLP::setParameters() {
	...
	for (double c = 100000; c > 0.0001; c/=2) {
		...
		CSVM::cmdRun("echo C:\\Test\\svm-train.exe -s 0 -t 0 -c " + itos(c) + " -q C:\\Test\\SVF.txt C:\\Test\\SVFTraining.txt00.model >> C:\\Test\\linear.bat");
...
"*/
	for (double c = 100000; c > 0.0001; c /= 2) {
		for (double g = 100; g > 0.0001; g /= 2) {
			for (double r = 10; r > 0.01; r /= 2){
			CSVM::cmdRun("echo C:\\Test\\svm-train.exe -s 0 -t 1 -c " + itos(c) + " -g " + itos(g) + " -r " + itos(r) + " -q C:\\Test\\SVF.txt C:\\Test\\SVFTraining.txt00.model >> C:\\Test\\linear.bat");
			//CSVM::cmdRun("echo echo svm-train.exe -s 0 -t 1 -c " + itos(c) + " \>\> C:\\Test\\r.txt >> C:\\Test\\linear.bat");
			CSVM::cmdRun("echo C:\\Test\\svm-predict.exe C:\\Test\\SVFT1Zb1.txt C:\\Test\\SVFTraining.txt00.model C:\\Test\\result \>\> C:\\Test\\r.txt >> C:\\Test\\linear.bat");
			CSVM::cmdRun("echo C:\\Test\\svm-predict.exe C:\\Test\\VF.txt C:\\Test\\SVFTraining.txt00.model C:\\Test\\result \>\> C:\\Test\\r.txt >> C:\\Test\\linear.bat");
			}
		}
