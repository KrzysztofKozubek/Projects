...
void RecognitionNLP::myTest() {
	...
	const string PATH_TRAIN_DEFOR = "C:\\Test\zbiory\\uczacy\\deformacja\\";
	const string PATH_TRAIN_PROCE = "C:\\Test\zbiory\\uczacy\\proceswstepny\\";
	const string PATH_TRAIN_SEGME = "C:\\Test\zbiory\\uczacy\\segmentacja\\";
	const string PATH_TESTI_DEFOR = "C:\\Test\zbiory\\uczacy\\deformacja\\";
	const string PATH_TESTI_PROCE = "C:\\Test\zbiory\\uczacy\\proceswstepny\\";
	const string PATH_TESTI_SEGME = "C:\\Test\zbiory\\uczacy\\segmentacja\\";
	const string PATH_TESII_DEFOR = "C:\\Test\zbiory\\uczacy\\deformacja\\";
	const string PATH_TESII_PROCE = "C:\\Test\zbiory\\uczacy\\proceswstepny\\";
	const string PATH_TESII_SEGME = "C:\\Test\zbiory\\uczacy\\segmentacja\\";
	...
	/* LOAD DATA */
	clearFolder("C:\\Test\zbiory\\uczacy\\deformacja\\");
	clearFolder("C:\\Test\zbiory\\uczacy\\proceswstepny\\");
	clearFolder("C:\\Test\zbiory\\uczacy\\segmentacja\\");
	clearFolder("C:\\Test\zbiory\\testI\\deformacja\\");
	clearFolder("C:\\Test\zbiory\\testI\\proceswstepny\\");
	clearFolder("C:\\Test\zbiory\\testI\\segmentacja\\");
	clearFolder("C:\\Test\zbiory\\testII\\deformacja\\");
	clearFolder("C:\\Test\zbiory\\testII\\proceswstepny\\");
	clearFolder("C:\\Test\zbiory\\testII\\segmentacja\\");
