...
#pragma endregion create parameters segmentation
	...
	insertToFile("TEST I.bat", "@echo OFF");
	for (int c = 1; c < 10000; c *= 2) {

		insertToFile("TEST I.bat", "echo Kernel = Linear, Test = I, C = " + itos(c) + ": ");
		insertToFile("TEST I.bat", "..\\" + PATH_LIBSVM + "svm-train.exe -s 0 -t 0 -c " + itos(c) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_LINEAR);
		insertToFile("TEST I.bat", "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_I + " ..\\" + PATH_MODEL_LINEAR + " ..\\" + RESULT_FILE);
		insertToFile("TEST I.bat", "echo  ");
		for (double g = 0.001953125; g < 10; g *= 2) {

			insertToFile("TEST I.bat", "echo Kernel = RBF, Test = I, C = " + itos(c) + ", g = " + itos(g) + ":");
			insertToFile("TEST I.bat", "..\\" + PATH_LIBSVM + "svm-train.exe -s 0 -t 2 -c " + itos(c) + " -g " + itos(g) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_RBF);
			insertToFile("TEST I.bat", "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_I + " ..\\" + PATH_MODEL_RBF + " ..\\" + RESULT_FILE);
		}
		insertToFile("TEST I.bat", "echo  ");
	}
	...
	insertToFile("TEST II.bat", "@echo OFF");
	for (int c = 1; c < 10000; c *= 2) {

		insertToFile("TEST II.bat", "echo Kernel = Linear, Test = II, C = " + itos(c) + ": ");
		insertToFile("TEST II.bat", "..\\" + PATH_LIBSVM + "svm-train.exe -s 0 -t 0 -c " + itos(c) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_LINEAR);
		...
		for (double g = 0.001953125; g < 10; g *= 2) {
			...
			insertToFile("TEST II.bat", "..\\" + PATH_LIBSVM + "svm-train.exe -s 0 -t 2 -c " + itos(c) + " -g " + itos(g) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_RBF);
			insertToFile("TEST II.bat", "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_II + " ..\\" + PATH_MODEL_RBF + " ..\\" + RESULT_FILE);
		}
		insertToFile("TEST II.bat", "echo  ");
	}
