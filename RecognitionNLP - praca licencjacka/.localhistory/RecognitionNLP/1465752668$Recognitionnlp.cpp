...
void RecognitionNLP::myTest() {
	...
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -r %r% -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "13.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -r %r% -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "13.model >> " + pathTest + "skrypt.bat");
