...
void RecognitionNLP::myTest() {
	...
	vector<string> fileToRemove = getListFileFrom("D:\\Segmentation\\");
	string fileToRemoveTmp;
	for each(string var in fileToRemove) {
		fileToRemoveTmp = "D:\\Segmentation\\" + var;
	...
	nu_svm.saveVectorToFile(labelT1Training, trainingDataT1Training, pathTest + test1Training, nrT1Training);
	//save test 2 SVF training
	nu_svm.saveVectorToFile(labelT2Training, trainingDataT2Training, pathTest + test2Training, nrT2Training);

	//save test 1 SVF set 1
	nu_svm.saveVectorToFile(labelT1Zb1, trainingDataT1Zb1, pathTest + test1Zb1, nrT1Zb1);
	//save test 1 SVF set 2
	nu_svm.saveVectorToFile(labelT1Zb2, trainingDataT1Zb2, pathTest + test1Zb2, nrT1Zb2);

	//save test 2 SVF set 1
	nu_svm.saveVectorToFile(labelT2Zb1, trainingDataT2Zb1, pathTest + test2Zb1, nrT2Zb1);
	//save test 2 SVF set 2
	nu_svm.saveVectorToFile(labelT2Zb2, trainingDataT2Zb2, pathTest + test2Zb2, nrT2Zb2);
	...
	CSVM::cmdRun("echo SET \"g=5\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo SET \"d=5\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo SET \"r=1\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo SET \"p=0.1\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo SET \"m=1000\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo SET \"h=1\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo SET \"wi=5\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "10.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "10.model >> " + pathTest + "skrypt.bat");
	...
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "11.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "11.model >> " + pathTest + "skrypt.bat");
	...
	CSVM::cmdRun("echo SET \"n=0.001\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo SET \"g=0.6\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "12.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "12.model >> " + pathTest + "skrypt.bat");
	...
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "13.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "13.model >> " + pathTest + "skrypt.bat");
	...
	CSVM::cmdRun("echo SET \"n=0.001\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "00.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "00.model >> " + pathTest + "skrypt.bat");
	...
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "01.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "01.model >> " + pathTest + "skrypt.bat");
	...
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "02.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "02.model >> " + pathTest + "skrypt.bat");
	...
	CSVM::cmdRun("echo SET \"g=0.5\" >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test1Training + " " + pathTest + test1Training + "03.model >> " + pathTest + "skrypt.bat");
	CSVM::cmdRun("echo " + pathTest + "svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q " + pathTest + test2Training + " " + pathTest + test2Training + "03.model >> " + pathTest + "skrypt.bat");
...
void RecognitionNLP::segmentation() {
	...
	CSegmentation segmentation(&distorted, vParameters);
	segmentation.segmentationNLP(NLP, vParameters[10], false, true, true);
	segmentation.~CSegmentation();
}
...
void RecognitionNLP::saveFileVectorFeauter() {
	...
	CSegmentation segmentation(&distorted, vParameters);
	segmentation.segmentationNLP(NLP, vParameters[10], vParameters[10], false);
