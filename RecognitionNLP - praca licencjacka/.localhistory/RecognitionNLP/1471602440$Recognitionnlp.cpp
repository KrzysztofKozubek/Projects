...
RecognitionNLP::RecognitionNLP(QWidget *parent) : QMainWindow(parent) {
	...
	//buton test
	connect(ui.buttonTest, SINGNAL(released()), this, SLOT(test()));
...
#pragma endregion create propertys segmentation 
	...
	for (int i = 0; i < vLabelTestI.size(); i++) {
...
#pragma endregion create parameters segmentation
	...
	insertToFile(GS_LINEAR, "@echo OFF");
	insertToFile(GS_LINEAR, "SET \"svm=0\"");
	insertToFile(GS_LINEAR, "SET \"kernel=0\"");
	//Linear
	for (int c = 1; c < 10000; c *= 2) {
		insertToFile(GS_LINEAR, "..\\" + PATH_LIBSVM + "svm-train.exe -s %svm% -t %kernel% -c " + itos(c) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_LINEAR);
		insertToFile(GS_LINEAR, "echo Kernel = Linear, Test = I, C = " + itos(c) + ":");
		insertToFile(GS_LINEAR, "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_I + " ..\\" + PATH_MODEL_LINEAR + " ..\\" + RESULT_FILE);
		insertToFile(GS_LINEAR, "echo Kernel = Linear, Test = II, C = " + itos(c) + ":");
		insertToFile(GS_LINEAR, "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_II + " ..\\" + PATH_MODEL_LINEAR + " ..\\" + RESULT_FILE);
	}
	//RBF
	createFile(GS_RBF);
	insertToFile(GS_RBF, "@echo OFF");
	insertToFile(GS_RBF, "SET \"svm=0\"");
	insertToFile(GS_RBF, "SET \"kernel=2\"");
	for (int c = 1; c < 10000; c *= 2) {
		for (double g = 0.001953125; g < 10; g *= 2) {
			insertToFile(GS_RBF, "..\\" + PATH_LIBSVM + "svm-train.exe -s %svm% -t %kernel% -c " + itos(c) + " -g " + itos(g) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_RBF);
			insertToFile(GS_RBF, "echo Kernel = RBF, Test = I, C = " + itos(c) + ", g = " + itos(g) + ":");
			insertToFile(GS_RBF, "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_I + " ..\\" + PATH_MODEL_RBF + " ..\\" + RESULT_FILE);
			insertToFile(GS_RBF, "echo Kernel = RBF, Test = II, C = " + itos(c) + ", g = " + itos(g) + ":");
			insertToFile(GS_RBF, "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_II + " ..\\" + PATH_MODEL_RBF + " ..\\" + RESULT_FILE);
		}
	}

	//Test I
	createFile("SCRIPTS\\TEST I.bat");
	insertToFile("SCRIPTS\\TEST I.bat", "@echo OFF");
	for (int c = 1; c < 10000; c *= 2) {

		insertToFile("SCRIPTS\\TEST I.bat", "echo Kernel = Linear, Test = I, C = " + itos(c) + ": ");
		insertToFile("SCRIPTS\\TEST I.bat", "..\\" + PATH_LIBSVM + "svm-train.exe -s 0 -t 0 -c " + itos(c) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_LINEAR);
		insertToFile("SCRIPTS\\TEST I.bat", "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_I + " ..\\" + PATH_MODEL_LINEAR + " ..\\" + RESULT_FILE);
		insertToFile("SCRIPTS\\TEST I.bat", "echo  ");
		for (double g = 0.001953125; g < 10; g *= 2) {

			insertToFile("SCRIPTS\\TEST I.bat", "echo Kernel = RBF, Test = I, C = " + itos(c) + ", g = " + itos(g) + ":");
			insertToFile("SCRIPTS\\TEST I.bat", "..\\" + PATH_LIBSVM + "svm-train.exe -s 0 -t 2 -c " + itos(c) + " -g " + itos(g) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_RBF);
			insertToFile("SCRIPTS\\TEST I.bat", "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_I + " ..\\" + PATH_MODEL_RBF + " ..\\" + RESULT_FILE);
		}
		insertToFile("SCRIPTS\\TEST I.bat", "echo  ");
	}

	//Test II
	createFile("SCRIPTS\\TEST II.bat");
	insertToFile("SCRIPTS\\TEST II.bat", "@echo OFF");
	for (int c = 1; c < 10000; c *= 2) {

		insertToFile("SCRIPTS\\TEST II.bat", "echo Kernel = Linear, Test = II, C = " + itos(c) + ": ");
		insertToFile("SCRIPTS\\SCRIPTS\\TEST II.bat", "..\\" + PATH_LIBSVM + "svm-train.exe -s 0 -t 0 -c " + itos(c) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_LINEAR);
		insertToFile("TEST II.bat", "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_II + " ..\\" + PATH_MODEL_LINEAR + " ..\\" + RESULT_FILE);
		insertToFile("SCRIPTS\\TEST II.bat", "echo  ");
		for (double g = 0.001953125; g < 10; g *= 2) {

			insertToFile("SCRIPTS\\TEST II.bat", "echo Kernel = RBF, Test = II, C = " + itos(c) + ", g = " + itos(g) + ":");
			insertToFile("SCRIPTS\\TEST II.bat", "..\\" + PATH_LIBSVM + "svm-train.exe -s 0 -t 2 -c " + itos(c) + " -g " + itos(g) + " -q ..\\" + PATH_NVF_TRAINING + " ..\\" + PATH_MODEL_RBF);
			insertToFile("SCRIPTS\\TEST II.bat", "..\\" + PATH_LIBSVM + "svm-predict.exe ..\\" + PATH_NVF_TEST_II + " ..\\" + PATH_MODEL_RBF + " ..\\" + RESULT_FILE);
		}
		insertToFile("SCRIPTS\\TEST II.bat", "echo  ");
	}
