...
private:
	...
	void showResultImage(Mat image);
	void showResultImage(CListChange list);
	void setSceneValue(vector<string> values, vector<double> min, vector<double> max);
	void setRangeSliderValue(vector<double> min, vector<double> max);
	void setVector(vector<string>& str, vector<double>& vmin, vector<double>& vmax, string parametr, double min, double max);
	void fillDefaultValue();
	double* getValueFromTest();
	void setSceneSegmentationValue(vector<string> values, vector<double> min, vector<double> max, vector<double> value);
	void showSegmentationResultImage();
	*/
