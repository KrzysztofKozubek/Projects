...
C:\Test\svm-predict.exe C:\Test\SVFT2Zb1.txt C:\Test\SVFT1Training.txt02.model C:\Test\result
...
SET "c=20" 
SET "g=0.3" 
C:\Test\svm-train.exe -s %svm% -t %kernel% -g %g% -r %r% -e %e% -c %c% -n %n% -q C:\Test\SVFT1Training.txt C:\Test\SVFT1Training.txt03.model 
C:\Test\svm-train.exe -s %svm% -t %kernel% -g %g% -r %r% -e %e% -c %c% -n %n% -q C:\Test\SVFT2Training.txt C:\Test\SVFT2Training.txt03.model 
