...
SET "e=1" 
SET "n=0.001" 
C:\Test\svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q C:\Test\SVFT1Training.txt C:\Test\SVFT1Training.txt00.model 
C:\Test\svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q C:\Test\SVFT2Training.txt C:\Test\SVFT2Training.txt00.model 
...
C:\Test\svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q C:\Test\SVFT2Training.txt C:\Test\SVFT2Training.txt01.model 
...
C:\Test\svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q C:\Test\SVFT2Training.txt C:\Test\SVFT2Training.txt02.model 
...
C:\Test\svm-train.exe -s %svm% -t %kernel% -d %d% -r %r% -p %p% -m %m% -h %h% -wi %wi%  -g %g% -e %e% -c %c% -n %n% -q C:\Test\SVFT2Training.txt C:\Test\SVFT2Training.txt03.model 
